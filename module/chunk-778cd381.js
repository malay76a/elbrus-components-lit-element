import { a as _decorate, b as customElement, d as css, i as unsafeCSS, e as html, f as LitElement, c as property } from './chunk-96426fcb.js';
...
let UcFooterSocialLinks = _decorate([customElement('uc-footer-social-links')], function (_initialize, _LitElement) {
  class UcFooterSocialLinks extends _LitElement {
    constructor(...args) {
      super(...args);
...
let UcFooterSubscribe = _decorate([customElement('uc-footer-subscribe')], function (_initialize, _LitElement) {
  class UcFooterSubscribe extends _LitElement {
    constructor(...args) {
      super(...args);
...
let UcFooterLinkBlock = _decorate([customElement('uc-footer-link-block')], function (_initialize, _LitElement) {
  class UcFooterLinkBlock extends _LitElement {
    constructor(...args) {
      super(...args);
...
//# sourceMappingURL=chunk-778cd381.js.map
