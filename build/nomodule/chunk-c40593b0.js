System.register(['./chunk-65e75638.js', './chunk-d72fc7c5.js', './chunk-eee526ef.js'], function (exports, module) {
    'use strict';
    var _typeof, _decorate, _inherits, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _assertThisInitialized, _get, _taggedTemplateLiteral, customElement, css, unsafeCSS, html, LitElement, uniqid;
    return {
        ...
        execute: function () {
            ...
            (function (factory) {
              ...
              function scope(target, options, originalOptions) {
                ...
                var scope_Connects;
                var scope_Pips;
                var scope_Tooltips; // Override for the 'animate' option

                var scope_ShouldAnimate = true; // Slider state values
            ...
            var UcFacetSlider = _decorate([customElement('uc-facet-slider')], function (_initialize, _LitElement) {
              var UcFacetSlider =
              /*#__PURE__*/
              function (_LitElement2) {
                _inherits(UcFacetSlider, _LitElement2);

                function UcFacetSlider() {
                  var _this;

                  _classCallCheck(this, UcFacetSlider);

                  _this = _possibleConstructorReturn(this, _getPrototypeOf(UcFacetSlider).call(this));
              ...
              return {
                ...
                d: [{
                  ...
                  value: function firstUpdated(_changedProperties) {
                    _get(_getPrototypeOf(UcFacetSlider.prototype), "firstUpdated", this).call(this, _changedProperties);

                    this.slider = this.shadowRoot.querySelector("#".concat(this.id));
                    var inputs = Array.from(this.shadowRoot.querySelectorAll('.input-field'));
                    var resetButton = this.shadowRoot.querySelector('.reset');
                  ...
                  value: function render() {
                    return html(_templateObject2(), this.id);
                  }
                }]
              };
            }, LitElement);
            ...
            var UcCurrentFilter = _decorate([customElement('uc-facet-checkbox-item')], function (_initialize, _LitElement) {
              var UcCurrentFilter =
              /*#__PURE__*/
              function (_LitElement2) {
              ...
              return {
                ...
                d: [{
                  ...
                  key: "styles",
                  value: function value() {
                    return css(_templateObject$1(), unsafeCSS(css$4));
                  }
                }, {
                  kind: "method",
                  key: "render",
                  value: function render() {
                    return html(_templateObject2$1(), this.id, this.checked, this.disabled, this.id, this.label, this.count);
                  }
                }]
              };
            }, LitElement);
            ...
            var UcCurrentFilter$1 = _decorate([customElement('uc-facet-checkbox-group')], function (_initialize, _LitElement) {
              var UcCurrentFilter =
              /*#__PURE__*/
              function (_LitElement2) {
                _inherits(UcCurrentFilter, _LitElement2);
                ...
                function UcCurrentFilter() {
                  ...
                  _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(UcCurrentFilter)).call.apply(_getPrototypeOf2, [this].concat(args)));
              ...
              return {
                ...
                d: [{
                  ...
                  key: "styles",
                  value: function value() {
                    return css(_templateObject$2(), unsafeCSS(css$3));
                  }
                }, {
                  kind: "method",
                  key: "render",
            ...
            var UcFacetToggle = _decorate([customElement('uc-facet-toggle')], function (_initialize, _LitElement) {
              var UcFacetToggle =
              /*#__PURE__*/
              function (_LitElement2) {
                _inherits(UcFacetToggle, _LitElement2);

                function UcFacetToggle() {
                  var _this;

                  _classCallCheck(this, UcFacetToggle);

                  _this = _possibleConstructorReturn(this, _getPrototypeOf(UcFacetToggle).call(this));
              ...
              return {
                ...
                d: [{
                  ...
                  key: "styles",
                  value: function value() {
                    return css(_templateObject$3(), unsafeCSS(css$1));
                  }
                }, {
                  kind: "method",
                  key: "toggle",
                  ...
                  key: "render",
                  value: function render() {
                    return html(_templateObject2$3(), this.titleFacet ? html(_templateObject3(), this.titleFacet) : html(_templateObject4()), this.toggle, !this.closed ? html(_templateObject5()) : html(_templateObject6()));
                  }
                }]
              };
            }, LitElement);
...
//# sourceMappingURL=chunk-c40593b0.js.map
